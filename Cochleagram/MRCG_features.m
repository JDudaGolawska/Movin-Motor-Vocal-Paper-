...
g = gammatoneFast(sig, 64, [50 8000], sampFreq); % Gammatone filterbank responses

cochlea1 = log10(cochleagram_git(g,sampFreq*0.025,sampFreq*0.010));
cochlea2 = log10(cochleagram_git(g,sampFreq*0.200,sampFreq*0.010));
cochlea1 = cochlea1(:,:);
cochlea2 = cochlea2(:,:);
